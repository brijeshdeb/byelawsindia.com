  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        {
          label: "Nominations",
          href: "/members/nominations",
          icon: "diversity_1",
          anyOf: [PERMISSIONS.NOMINATION_READ, PERMISSIONS.NOMINATION_MANAGE],
        },
        {
          label: "Associate Members",
          href: "/members/associates",
          icon: "group_add",
          anyOf: [PERMISSIONS.ASSOCIATE_MEMBER_READ, PERMISSIONS.ASSOCIATE_MEMBER_MANAGE],
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          anyOf: [
            ...
            PERMISSIONS.SERVICE_REQUEST_PROCESS,
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          href: "/vendor",
          icon: "store",
          permission: PERMISSIONS.VENDOR_PORTAL,
        },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          icon: "dataset",
          permission: PERMISSIONS.ADMIN_MASTER_DATA,
        },
        {
          label: "Templates",
          href: "/admin/templates",
          icon: "draft",
          permission: PERMISSIONS.ADMIN_TEMPLATES,
        },
      ],
    },
    {
